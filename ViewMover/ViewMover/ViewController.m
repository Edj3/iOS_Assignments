...
- (void)viewDidLoad
{
    ...
    myTimer = [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(moveSquare) userInfo:nil repeats:YES];
    
    //set initial state of squares
    UIView *view1 = [[UIView alloc]initWithFrame:CGRectMake(30, 400, 20, 20)];
    UIView *view2 = [[UIView alloc]initWithFrame:CGRectMake(90, 400, 20, 20)];
    UIView *view3 = [[UIView alloc]initWithFrame:CGRectMake(150, 400, 20, 20)];
    UIView *view4 = [[UIView alloc]initWithFrame:CGRectMake(210, 400, 20, 20)];
    UIView *view5 = [[UIView alloc]initWithFrame:CGRectMake(270, 400, 20, 20)];
...
-(void)moveSquare
{
    ...
    [UIView animateWithDuration:0.5 animations:^{
        [MyView setFrame:CGRectMake(myX,myY - (rand() % 101),20,20)];}];
    if (myY < 0) {
        [myTimer invalidate];
    }
    //400 - (rand() %101)
